...
const LMS_DATA = (function () {
  const campaigns = [
    { id: "camp-st-anne", name: "St. Anne Hospital Acquisition", status: "Active", goLiveDate: shiftIso("2026-07-15"), phase: "Training execution", readiness: 76, readinessScore: 68, risk: "high", scoringProfile: { completion_threshold: 95, critical_role_threshold: 98, identity_mismatch_penalty: 2 }, homeSummary: { user_campaign_role: "readiness_lead", default_home_view: "executive_summary", cards: { open_exceptions: 3, departments_at_risk: 2, sessions_due: 3, readiness_score: 68 } } },
    { id: "camp-riverbend", name: "Riverbend Medical Center Acquisition", status: "Planning", goLiveDate: shiftIso("2026-10-03"), phase: "Roster intake", readiness: 12, readinessScore: 42, risk: "medium", scoringProfile: { completion_threshold: 90, critical_role_threshold: 95, identity_mismatch_penalty: 2 }, homeSummary: { user_campaign_role: "program_admin", default_home_view: "executive_summary", cards: { open_exceptions: 0, departments_at_risk: 2, sessions_due: 0, readiness_score: 42 } } },
    { id: "camp-ambulatory-wave2", name: "Ambulatory Wave 2", status: "Draft", goLiveDate: shiftIso("2026-11-12"), phase: "Matrix design", readiness: 0, readinessScore: 0, risk: "low", scoringProfile: { completion_threshold: 85, critical_role_threshold: 90, identity_mismatch_penalty: 1 }, homeSummary: { user_campaign_role: "training_coordinator", default_home_view: "executive_summary", cards: { open_exceptions: 0, departments_at_risk: 0, sessions_due: 0, readiness_score: 0 } } },
  ];
